...
# Load data----
# https://cellxgene.cziscience.com/collections, UMAP of B cells, Seurat v4
seu <- readRDS("RDSfiles/Bcells.rds")
seu
View(seu@meta.data)
DefaultDimReduc(seu)
...
saveRDS(seu, file = "RDSfiles/Bcells_annotated.RDS")
...
write.table(propres, file = "results/DA//propeller_Bcells_ARID1AHvsL.txt", sep ="\t", col.names = T,row.names = F)
